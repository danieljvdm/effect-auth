/* oxlint-disable no-explicit-any -- private mapped-row kernel; public descriptors retain concrete tables. */
import { sql } from "drizzle-orm";
import { Effect } from "effect";

import { PasskeyClaim, type PasskeyAccess, type PasskeyCeremony } from "../passkey/models";
...
export const contextRegistration = Effect.fn("passkey.contextRegistration")(function* (
  mapping: any,
...
export const claimRegistration = Effect.fn("passkey.claimRegistration")(function* (
  mapping: any,
  input: {
...
export const settleRegistration = Effect.fn("passkey.settleRegistration")(function* (
  mapping: any,
  claim: PasskeyClaim,
