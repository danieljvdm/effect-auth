...
import * as M from "../oauth/connectedModels";
import { OAuthConnectedPersistence } from "../oauth/OAuthConnectedPersistence";
import {
  OAuthConnectedRevocations,
  OAuthConnectedRevocationDecision,
} from "../oauth/OAuthConnectedRevocations";
import type { PrepareOAuthCommit } from "../oauth/OAuthSignInPersistence";
import { OAuthExternalIdentity } from "../oauth/signInModels";
...
const mutation =
  <Input, Value, Encoded>(
    ...
    body: (
      ...
      Value,
      import("../oauth/signInErrors").OAuthUnavailable | DrizzleMappingError,
