...
import { type RecoveryReference, type LoginIdentifier } from "../identity/models";
import type {
  PasswordAction,
  PasswordAttemptId,
...
import type { PasswordRegistrationDecision } from "../password/methods/module";
import type { EncodedPasswordHash } from "../password/models";
...
> {
  ...
  }) => Effect.Effect<PasswordCredentialSnapshot, DrizzleMappingError>;
}
...
> extends PasswordConstraintClassifier {
  ...
  readonly allocateAttemptId?: Effect.Effect<PasswordAttemptId, DrizzleMappingError>;
