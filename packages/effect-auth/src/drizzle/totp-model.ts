...
import type { PendingAuthenticationContext } from "../sessions/PendingAuthentication";
import type { TotpPolicy } from "../totp/models";
import { TotpPersistence } from "../totp/TotpPersistence";
import type { DrizzleMappingError } from "./model";
export type TotpColumn<T extends Table> = Extract<keyof T["_"]["columns"], string>;
export type TotpMappingSource<M, R = never> = M | Effect.Effect<M, DrizzleMappingError, R>;
