/* oxlint-disable no-explicit-any -- private row bridge; concrete makers retain every table/native-ID type. */
...
import { validatePasskeyPolicy } from "../passkey/policy";
...
export const readSubject = Effect.fn("passkey.readSubject")(function* (
  mapping: any,
  subjectId: SubjectId,
) {
...
export const readModule = Effect.fn("passkey.readModule")(function* (mapping: any) {
  const owner = yield* CurrentPasskeyTransaction;
...
export const readPolicyGuards = Effect.fn("passkey.readPolicyGuards")(function* (mapping: any) {
  const owner = yield* CurrentPasskeyTransaction;
...
export const discoverSubject = Effect.fn("passkey.discoverSubject")(function* (
  mapping: any,
  rpId: string,
  ...
  invariant(
    row[descriptor.rpId] === rpId && row[descriptor.protocolCredentialId] === protocolCredentialId,
  );
...
export const readRevision = Effect.fn("passkey.readRevision")(function* (
  mapping: any,
  subject: SubjectRead,
...
export const readCredential = Effect.fn("passkey.readCredential")(function* (
  mapping: any,
  subject: SubjectRead,
  rpId: string,
  protocolCredentialId: string,
  ...
  invariant(handleRow[handle.rpId] === rpId && handleRow[handle.userHandle] === decoded.userHandle);
  ...
  const credential = snapshotPasskeySync(PasskeyCredential, { ...decoded, revision, active: true });
...
export const lookupCredential = Effect.fn("passkey.lookupCredential")(function* (
  mapping: any,
  rpId: string,
  protocolCredentialId: string,
) {
...
export const captureEnrollmentContext = Effect.fn("passkey.captureEnrollmentContext")(function* (
  mapping: any,
