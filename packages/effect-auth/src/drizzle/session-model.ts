...
import type { StatefulSessionRecord } from "../sessions/persistence";
...
export interface SessionIdCodec<NativeId> {
  readonly toNative: (id: SessionId) => Effect.Effect<NativeId, DrizzleMappingError>;
  readonly toSession: (id: NativeId) => Effect.Effect<SessionId, DrizzleMappingError>;
...
export interface SessionFlowTables<Flow extends Table, NativeSubjectId> {
  readonly flow: {
    ...
    readonly decodeInstant: (native: unknown) => Effect.Effect<DateTime.Utc, DrizzleMappingError>;
...
> extends SessionFlowTables<Flow, NativeSubjectId> {
  readonly session: {
    ...
    ) => Effect.Effect<StatefulSessionRecord<Claims>, DrizzleMappingError>;
    readonly allocateId?: Effect.Effect<NativeSessionId, DrizzleMappingError>;
    readonly allocateIdSync?: () => NativeSessionId;
    readonly allocateVersion?: Effect.Effect<SecurityRevision, DrizzleMappingError>;
...
> extends SessionFlowTables<Flow, NativeSubjectId> {
  readonly pending: {
    ...
    ) => Effect.Effect<PendingAuthenticationRecord<Claims>, DrizzleMappingError>;
    ...
    readonly decodeContext: (
      row: InferSelectModel<Pending>,
    ) => Effect.Effect<PendingAuthenticationState, DrizzleMappingError>;
    readonly allocateVersion?: Effect.Effect<SecurityRevision, DrizzleMappingError>;
    readonly allocateVersionSync?: () => SecurityRevision;
  };
}
