...
import type { PasskeyCeremony, PasskeyCredential } from "../passkey/models";
import { PasskeyCredentials } from "../passkey/PasskeyCredentials";
import { PasskeyEnrollmentContext } from "../passkey/PasskeyEnrollmentContext";
import { PasskeyPersistence } from "../passkey/PasskeyPersistence";
...
export type PasskeyMappingSource<M, RSetup = never> =
  | M
  | Effect.Effect<M, DrizzleMappingError, RSetup>;
