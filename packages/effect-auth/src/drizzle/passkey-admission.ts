/* oxlint-disable no-explicit-any -- private typed-mapping execution bridge. */
import { sql, type SQL } from "drizzle-orm";
import { Effect } from "effect";

import type { PasskeyCeremony } from "../passkey/models";
import type { PasskeyMethodPolicy } from "../passkey/policy";
import type { PasskeyChargeKind } from "./passkey-model";
import {
  col,
  equal,
  existsExact,
...
export const chargeRetentionMillis = 86_400_000;

export const chargeScopes = (ceremony: PasskeyCeremony, subjectId?: string) => {
...
export const lockAdmission = Effect.fn("passkey.lockAdmission")(function* (mapping: any) {
  ...
  const marked = { ...identity, [table.version]: owner.marker, [table.ownerMarker]: owner.marker };
...
export const readCharges = Effect.fn("passkey.readCharges")(function* (
  mapping: any,
  ceremony: PasskeyCeremony,
...
export const guardChargeSet = (mapping: any, ceremony: PasskeyCeremony, subjectId?: string) =>
...
export const insertCharges = Effect.fn("passkey.insertCharges")(function* (
  mapping: any,
  ceremony: PasskeyCeremony,
  policy: PasskeyMethodPolicy,
