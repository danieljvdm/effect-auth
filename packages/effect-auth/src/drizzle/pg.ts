...
import { AuthStore, EmailOtpRejected } from "../AuthStore";
...
import { AuthStoreDecisions } from "../internal/AuthStoreDecisions";
import { reportPersistenceFailure } from "../internal/diagnostics";
import { InvalidOAuthState } from "../oauth/errors";
import { OAuthStateDecisions } from "../oauth/OAuthStateDecisions";
    ...
    const attempt = db.transaction((tx) =>
      Effect.gen(function* () {
        ...
        if (nativeId === undefined) {
          return yield* DrizzleMappingError.make({
