...
import { PasswordRejected, PasswordUnavailable } from "../password/methods/errors";
import type { PasswordMutationDecision } from "../password/methods/models";
import type { PreparePasswordCommit } from "../password/methods/PasswordPersistence";
import type {
...
import { ProofBinding } from "../proofs/models";
...
import { DrizzleMappingError, column, updateValues } from "./model";
import type {
              ...
              Effect.try({
                try: () => ({
                  ...
                  Schema.is(PasswordUnavailable)(cause)
                    ? cause
                    : DrizzleMappingError.make({ operation: "mapping", cause }),
              }),
            ),
          )
